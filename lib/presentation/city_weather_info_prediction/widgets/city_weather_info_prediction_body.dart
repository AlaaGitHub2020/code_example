...
class CityWeatherInfoPredictionBody extends StatefulWidget {
  const CityWeatherInfoPredictionBody({Key? key}) : super(key: key);

  @override
  State<CityWeatherInfoPredictionBody> createState() =>
      _CityWeatherInfoPredictionBodyState();
}

class _CityWeatherInfoPredictionBodyState
    extends State<CityWeatherInfoPredictionBody> {
  final log = getLogger();
